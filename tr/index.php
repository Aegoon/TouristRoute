...
<script type="text/javascript" src="js/createMapRoute.js"></script>
...
<body data-0="background-position:0px 0px;" data-100000="background-position:0px -10000px;">
	...
	<div class="ship" data-_foobar="top:0%;" data-_foobar-4000="top:100%;">
		<img src="img/ent.png"></img>
	</div>

	<div id ="sTop" class="sTop">
			<h1>Welcome to the Tourist Route Demo page! </h1>
			<h2>This is a demo version</h1>
	</div>
    ...
    <select id="end" onchange="calcRoute();">
      <option value="Diagonal 324, Barcelona, Espanya">Diagonal 324</option>
      <option value="Diagonal 1, Barcelona, Espanya">Diagonal 1</option>
      <option value="parque Guell, Barcelona, Espanya">parque Guell</option>
      <option value="Gasela 32, Barcelona, Espanya">Gasela</option>
      <option value="Sagrada Familia, Barcelona, Espanya">Sagrada Familia</option>
      <option value="pl. Catalunya, Barcelona, Espanya">pl. Catalunya</option>
    </select>
  </div>
  
  <div id="message_panel">panel</div>
  
  <button id="toMap" onclick="toMainMap()">Enrera</button>

	<div class="s1" id="map">
	</div>
	<div class="s1" id="routeMap">
	</div>

	<div class="space"></div>

	<div id ="s2" class="s2" data-1200="background-color:rgb(0,0,255);" data-top="background-color:rgb(255,0,0);">
		<h1>Section 2</h1>
	</div>
		<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="900px" height="1200px">
			<path
				...
				data-0="stroke-dashoffset:13000;" data-end="stroke-dashoffset:0;"
	...
	<div id ="s3" class="s3">
		<h1>Section 3</h1>	
		<button onclick="ch()">Press me</button>	
	</div>	
